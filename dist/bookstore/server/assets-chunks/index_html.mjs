...
<body><!--nghm-->
  <div style="display:flex; flex-direction:row; min-height:100vh;">
    ...
    <div style="flex:1; display:flex; flex-direction:column; margin-left:250px;">
      ...
      <footer>
        <p class="footer_page pt-2 pb-2">© 2024 Quotes &amp; Bookstore. All
          rights reserved.</p>
      </footer>
    </div>
  </div>
...
[
 ...
 <div class="card-body">
  ...
  <app-root ng-version="20.3.28" ngh="0" ng-server-context="ssg"></app-root>

<script src="main-UHKZM5QJ.js" type="module"></script>
